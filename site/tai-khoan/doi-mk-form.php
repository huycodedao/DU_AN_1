    ...
    <div class="card-body">
        ...
        <form action="<?= $SITE_URL ?>/tai-khoan/doi-mk.php" method="POST" id="form_doi_mk">
            ...
            <div class="form-group">
                ...
                <input name="mat_khau2" class="form-control" placeholder="Password" type="password" id="mat_khau2">
            </div> <!-- form-group// -->

            <div class="form-group">
                <label for="password" class="form-label">Xác nhân mật khẩu mới</label>
                <input name="mat_khau3" class="form-control" placeholder="Password" type="password">
            </div> <!-- form-group// -->
...
<p class="text-center mt-4">Bạn chưa có tài khoản? <a href="dang-ky.php">Đăng ký</a></p>
<br><br>
<!-- ============================ COMPONENT LOGIN  END.// ================================= -->