...
<nav class="navbar navbar-md navbar-expand-lg navbar-dark p-1">
    <div class="container">
        <a class="navbar-brand" href="<?= $SITE_URL ?>/trang-chinh/index.php">
            <img class="img-fluid logo" style="height: 30px; width: 50px" src="<?= $CONTENT_URL ?>/images/items/logo.jpg" alt="logo" >
        </a>
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarsExampleDefault">
            <ul class="navbar-nav m-auto nav">
                ...
                <li class="nav-item <?= $name_page == 'gioi_thieu' ? 'active' : '' ?>">
                    <a class="nav-link text-black" href="<?= $SITE_URL ?>/trang-chinh/index.php?gioi-thieu">Giới thiệu</a>
                </li>
