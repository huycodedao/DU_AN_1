...
if (isset($_SESSION['cart'])) {
    foreach ($_SESSION['cart'] as $index => $item) {
        // Tính tổng thành tiền cho từng sản phẩm và cộng vào tổng tổng
        $totalAll += ($item['don_gia'] - $item['giam_gia']) * $item['sl'];
    }
}
?>
        ...
        <table class="table table-responsive-md">
            ...
            <tbody class="text-center" id="giohang">
                ...
                <tr>
                    ...
                    <td> <span class="thanh_tien_sp"><?= number_format(($item['don_gia'] - $item['giam_gia']) * $item['sl'], 0, ".", ",") ?> đ</span></td>
                    <td class="pt-1 m-auto">
            ...
            <tfoot id="tongdonhang">
                <tr class="text-center">
                    ...
                    <td class="text-danger font-weight-bold">
                        <!-- Hiển thị tổng theo số thập phân -->
                        <span><?= number_format($totalAll, 0, '.', ',') ?> đ</span>
                    </td>
                    <td></td>
                </tr>
                <tr class="text-right">
